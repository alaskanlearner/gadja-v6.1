    ...
    async def start(self):
        ...
        if FORCE_SUB_1:
            try:
                ...
                self.LOGGER(__name__).warning(
                    f"Pastikan @{self.username} " "adalah admin di Channel Tersebut, Cek Chat ID F-Subs Channel Saat Ini: {FORCE_SUB_1}"
                )
                self.LOGGER(__name__).info(
                    "Bot Berhenti. Gabung Group https://t.me/SharingUserbot untuk Bantuan\n\n"
                )
        ...
        if FORCE_SUB_2:
            try:
                ...
                self.LOGGER(__name__).warning(
                    f"Pastikan @{self.username} " "adalah admin di Channel Tersebut, Cek Chat ID F-Subs Channel Saat Ini: {FORCE_SUB_2}"
                )
                self.LOGGER(__name__).info(
                    "Bot Berhenti. Gabung Group https://t.me/SharingUserbot untuk Bantuan\n\n"
                )
        ...
        if FORCE_SUB_3:
            try:
                ...
                self.LOGGER(__name__).warning(
                    f"Pastikan @{self.username} " "adalah admin di Channel Tersebut, Cek Chat ID F-Subs Channel Saat Ini: {FORCE_SUB_3}"
                )
                self.LOGGER(__name__).info(
                    "Bot Berhenti. Gabung Group https://t.me/SharingUserbot untuk Bantuan\n\n"
                )
        ...
        if FORCE_SUB_4:
            try:
                ...
                self.LOGGER(__name__).warning(
                    f"Pastikan @{self.username} " "adalah admin di Group Tersebut, Cek Chat ID F-Subs Group Saat Ini:: {FORCE_SUB_4}"
                )
                self.LOGGER(__name__).info(
                    "Bot Berhenti. Gabung Group https://t.me/SharingUserbot untuk Bantuan\n\n"
                )
        ...
        try:
            ...
            self.LOGGER(__name__).warning(
                ...
                "adalah admin di Channel DataBase anda, CHANNEL_DB Saat Ini: {CHANNEL_DB}"
            )
            self.LOGGER(__name__).info(
                "Bot Berhenti. Gabung Group https://t.me/SharingUserbot untuk Bantuan\n\n"
            )
